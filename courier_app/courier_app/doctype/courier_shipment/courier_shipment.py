...
def _create_customer(sender_name, sender_phone, sender_email):
    ...
    selling_settings = frappe.db.get_singles_dict("Selling Settings")
    customer = frappe.get_doc({
        "doctype": "Customer",
        "customer_name": sender_name,
        "customer_type": "Individual",
        "customer_group": selling_settings.get("customer_group") or "All Customer Groups",
        "territory": selling_settings.get("territory") or "All Territories",
    })
