    ...
    <div class="ct-route">
      <div class="ct-route-point">
        ...
        <div>
          ...
          ${ship.sender_name ? `<div class="ct-route-name">&nbsp;</div>` : ""}
        </div>
      </div>
